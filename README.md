...
**!!!Важно!!!**
Проект разрабатывался не для коммерческих целей, поэтому в качестве примера изображений с визуальными ассоциациями использовалось пособие "Японский с нуля" О.А. Первова. 
